...
class Homepage(FormView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        else: #se nao estiver autenticado redireciona para:
...
class Criarconta(FormView):
    ...
    def form_valid(self, form):
        form.save() # cria item no banco de dados
        return super().form_valid(form)

    def get_success_url(self):
        return reverse('filme:login') #reverse corresponde a um link, no caso link do 'filme:login'
